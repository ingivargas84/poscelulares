            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <label for="contacto1">Nombre Vendedor:</label>
                                <input type="text" class="form-control" placeholder="Nombre Vendedor:" name="contacto1" >
                            </div>
                            <div class="col-sm-6">
                                <label for="contacto2">Teléfono Vendedor:</label>
                                <input type="text" class="form-control" placeholder="Teléfono Vendedor:" name="contacto2" >
                            </div>
                        </div>
                        <br>
