...
@section('header')
    <section class="content-header">
        <h1>
          Saldo Final
          <small>Registrar Saldo Final</small>
        </h1>
        <ol class="breadcrumb">
...
@section('content')
    <form method="POST" id="RecargasmForm"  action="{{route('recargas.savem')}}">
            {{csrf_field()}}
            <div class="col-md-12">
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                ...
                                <input type="text" class="form-control" placeholder="Saldo:" name="saldo" id="saldo" >
                            </div>
                        </div>
                        <br>
                        <div class="text-right m-t-15">
                            <a class='btn btn-primary form-button' href="{{ route('recargas.index') }}">Regresar</a>
                            <button class="btn btn-success form-button" id="ButtonRecargam">Registrar Saldo Final</button>
                        </div>
