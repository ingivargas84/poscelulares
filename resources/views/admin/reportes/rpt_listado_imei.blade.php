...
@section('header')
    <section class="content-header">
        <h1>
          Listado de Imeis en Bodega
        </h1>
    </section>
@stop

@section('content')
    <form method="POST" id="RptListadoImeiForm"  action="{{route('reportes.pdf_listado_imei')}}" >
            {{csrf_field()}}
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="text-right m-t-15">
                            ...
                            <button id="ButtonRptListadoImei" class="btn btn-success form-button" >Generar PDF</button>
                        </div>
...
var validator = $('#RptListadoImeiForm').validate({
    onkeyup: false,
    ignore: [],
    rules: {
        producto_id: {
