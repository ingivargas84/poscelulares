...
@section('header')
    <section class="content-header">
        <h1>
          Totales de Ventas por Tienda
        </h1>
    </section>
@stop

@section('content')
    <form method="POST" id="RptVentasTotalesTiendaForm"  action="{{route('reportes.pdf_ventas_totales_tienda')}}" >
            {{csrf_field()}}
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-body">
                        ...
                        <div class="text-right m-t-15">
                            ...
                            <button id="ButtonRptVentasTotalesTienda" class="btn btn-success form-button">Generar PDF</button>
                        </div>
