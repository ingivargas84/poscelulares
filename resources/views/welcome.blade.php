...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #00377b;">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="#"><strong>Tiendas Melany</strong> <span class="sr-only">(current)</span></a>
      </li>
    </ul>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-10 col-md-10 mx-auto">
              ...
              <center><p class="copyright text-muted"><strong>Copyright &copy; 2021 · VR Informática y Sistemas. All rights reserved</strong> </p></center>
            </div>
          </div>
        </div>
      </footer>      
