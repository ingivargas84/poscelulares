var cuentas_cobrar_table = $('#cuentas_cobrar_table').DataTable({
    "responsive": true,
    "processing": true,
    "info": true,
    "showNEntries": true,
    ...
    },
    {
        ...
        "render": function (data, type, full, meta) {
            ...
            return "<div id='" + full.id + "' class='text-center'>" +
                ...
                "<i class='fas fa-info-circle' title='Ver detalle de la Cuenta'></i>" +
                "</a>" + "</div></div>";
        },
...
/**************************************************
 Methods for aiding in the pdfmake table creation
 *************************************************/
...
$(document).on('click', '#report', function () {
    ...
    var row_data = cuentas_cobrar_table.row($(this).closest('tr')).data();
    ...
    $.ajax({
        ...
        success: function (data) {
                ...
                content: [
                    ...
                    { text: "\n" },
                    {
                        columns: [
                            ...
                            {
                                text:[
                                    {text: 'Cliente:', style: 'subtitulo', alignment:'center'},
                                ]
                            },
                            {
                                text:[
                    ...
                    },
                    {
                        columns: [
                            ...
                            {
                                text:[
                                    { text: row_data.cliente, alignment: 'center'}
                                ]
                            },
                            {
                                text:[
                    ...
                    table(
                        details['data'],
                        ['fecha_ingreso', 'tipo', 'no_transaccion', 'forma_pago', 'monto'],
                        ['20%', '20%', '20%', '20%', '20%'],
                        true,
                        [{ text: 'Fecha', bold: 'true', },
                        { text: 'Transacción', bold: 'true', alignmentChild: 'center', alignment: 'center' },
                        { text: 'No. Pedido/Documento', bold: 'true', alignmentChild: 'center', alignment: 'center' },
            ...
            pdfMake.createPdf(dd).download('El Angel - Cuenta' + ' ' + row_data.cliente+'.pdf');
        },
        error: function () {
