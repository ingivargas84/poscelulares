     ...
     
    {
        ...
        "render": function(data, type, full, meta) {
            ...
            if(full.estado == 1){
                ...
                "<a href='"+urlActual+"/"+full.id+"/desactivar' class='desactivar-proveedor'"+ "data-method='post' data-id='"+full.id+"' >" + 
...
$(document).on('click', 'a.desactivar-proveedor', function(e) {
    e.preventDefault(); // does not go through with the link.

    var $this = $(this);    
    alertify.confirm('Desactivación de Proveedor', 'Esta seguro de Desactivar el proveedor', 
        function(){
            $('.loader').fadeIn();
            $.post({
                ...
                proveedores_table.ajax.reload();
                    alertify.set('notifier','position', 'top-center');
                    alertify.success('Proveedor Desactivado con Éxito!!');
            }); 
         }
        , function(){
            alertify.set('notifier','position', 'top-center'); 
